...
const form = useForm({
    permissions: [...props.subUser.permissions],
})
...
function submit() {
    form.put(`/cells/${props.cell.id}/users/${props.subUser.user.id}`)
}
</script>
...
<template>
    ...
    >
        <Head :title="`Edit User - ${cell.name}`" />

        <div class="min-h-screen bg-surface-dark text-white">
            <main class="px-4 py-5 sm:px-6 sm:py-7 lg:px-8">
                <form class="mx-auto max-w-5xl space-y-5" @submit.prevent="submit">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-zinc-400">
                                            Update access for {{ subUser.user.email }}.
                                        </p>
                                    </div>
                                </div>
                    ...
                    <section class="rounded-panel border border-zinc-800 bg-surface p-5 sm:p-6">
                        <div class="rounded-button border border-zinc-900 bg-[#0d0f11] p-4">
                            <div class="text-sm font-black text-white">
                                {{ subUser.user.name || subUser.user.email }}
                            </div>
